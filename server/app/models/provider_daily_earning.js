...
let providerdailyearningSchema = new Schema({
...
providerdailyearningSchema.index({provider_id: 1, date_tag: 1}, {background: true});

let ProviderDailyEarning = mongoose.model('provider_daily_earning', providerdailyearningSchema);
