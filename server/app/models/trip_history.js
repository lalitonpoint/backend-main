...
Trip_history.index({ 'split_payment_users.user_id': 1 }, { background: true }) // added for Login is taking too long
Trip_history.index({ typename: 1 }, { background: true })
...
Trip_history.index({ complete_date_tag: 1, is_provider_status: 1, }, { background: true });
Trip_history.index({ complete_date_tag: 1 }, { background: true });
Trip_history.index({ complete_date_tag: 1, is_trip_completed: 1 }, { background: true });
Trip_history.index({ is_trip_completed: 1 }, { background: true });
Trip_history.index({ is_trip_cancelled_by_user: 1 }, { background: true });
Trip_history.index({ pay_to_provider: 1 }, { background: true });
Trip_history.index({ complete_date_in_city_timezone: 1 }, { background: true });
Trip_history.index({ provider_id: 1 }, { background: true });
Trip_history.index({ is_trip_completed: 1, is_trip_cancelled_by_user: 1, pay_to_provider: 1 }, { background: true });
Trip_history.index({ is_paid: 1, is_trip_completed: 1, is_trip_end: 1 }, { background: true });
Trip_history.index({ payment_intent_id: 1 }, { background: true });
Trip_history.index({ user_type_id: 1, is_trip_end: 1 }, { background: true });


Trip_history = mongoose.model('Trip_history', Trip_history);
