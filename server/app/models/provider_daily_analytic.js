...
let provider_daily_analytic = new schema({
    unique_id: Number,
...
provider_daily_analytic.index({date_tag: 1}, {background: true});
provider_daily_analytic.index({provider_id: 1}, {background: true});
provider_daily_analytic.index({provider_id: 1, date_tag: 1}, {background: true});
